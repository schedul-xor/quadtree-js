goog.provide('schedul.qt.Base.test');
...
describe('schedul.qt.Base, general', function() {
  ...
  it('should return 1 for q2i(1,0)', function() {
    expect(schedul.qt.Base.q2i(1, 0)).to.be(1);
  });
  it('should return 2 for q2i(0,1)', function() {
    expect(schedul.qt.Base.q2i(0, 1)).to.be(2);
  });
  it('should return 3 for q2i(1,1)', function() {
    expect(schedul.qt.Base.q2i(1, 1)).to.be(3);
     });

  it('should return x=0,y=0 for 0', function() {
    expect(schedul.qt.Base.i2x(0)).to.be(0);
    expect(schedul.qt.Base.i2y(0)).to.be(0);
  });
  it('should return x=1,y=0 for 1', function() {
    expect(schedul.qt.Base.i2x(1)).to.be(1);
    expect(schedul.qt.Base.i2y(1)).to.be(0);
  });
  it('should return x=0,y=1 for 2', function() {
    expect(schedul.qt.Base.i2x(2)).to.be(0);
    expect(schedul.qt.Base.i2y(2)).to.be(1);
  });
  it('should return x=1,y=1 for 3', function() {
    expect(schedul.qt.Base.i2x(3)).to.be(1);
    expect(schedul.qt.Base.i2y(3)).to.be(1);
  });
});
